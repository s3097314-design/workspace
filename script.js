...
const translations = {
  en: {
    ...
    complaint_desc:'Submit feedback anonymously. Your identity is never stored.',
...
function handleSignup() {
  ...
  const newAccount = { id: identifier, name, password, role, createdAt: new Date().toISOString() };
